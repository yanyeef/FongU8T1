public class FunWith2DArrays
{
    ...
    {
        /* IMPLEMENT ME! */
        int row = strArray.length-1;
        int column = strArray[0].length -1;

        System.out.println(strArray[0][0]);
        System.out.println(strArray[0][column]);
        System.out.println(strArray[row][0]);
        System.out.println(strArray[row][column]);
    }
}
